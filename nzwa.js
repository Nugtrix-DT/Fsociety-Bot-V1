...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=994403742330:+994 40 374 23 30\n' // WhatsApp ID + phone number
            + 'END:VCARD'
prefix = botPrefix
blocked = []
...
async function starts() {
	...
	await nzwa.connect({timeoutMs: 30*1000})
        ...
        console.log('=> Fsociety Bot!')
        lolcatjs.fromString('[Fsociety] Hola gracias por usar mi bot, espero te guste ;)')
	...
	nzwa.on('chat-update', async (mek) => {
		try {
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '944403742330@s.whatsapp.net'
				...
				case 'rebaixar':
					...
					break
                                case 'randomhentai':
                                        ...
                                        reply(mess.wait)
                                        anu = await fetchJson(`https://tobz-api.herokuapp.com/api/hentai?apikey=APIKEYLU`, {method: 'get'})
                                ...
                                case 'loli':
                                        ...
                                        if (isLimit(sender)) return reply(ind.limitend(pusname))
                                        reply(mess.wait)
                                        anu = await fetchJson(`https://tobz-api.herokuapp.com/api/randomloli?apikey=APIKEYLU`, {method: 'get'})
                                        buffer = await getBuffer(anu.result)
                                        nzwa.sendMessage(from, buffer, image, {quoted: mek})
                                        await limitAdd(sender)
                                        break
			...
			tels = body.slice(6)
               ...
               if (data.error) return reply(data.error)
				...
				nzwa.updatePresence(from, Presence.composing) 
					...
					teks += `  Total : ${groupMembers.length}\n`
					for (let mem of groupMembers) {
						teks += `𝓕𝓼𝓸𝓬𝓲𝓮𝓽𝔂 👤 ${mem.jid.split('@')[0]}@c.us\n`
						members_id.push(mem.jid)
					}
				...
				case 'bc':
					nzwa.updatePresence(from, Presence.composing) 
					if (!isOwner) return reply(ind.ownerB())
					if (args.length < 1) return reply('ʄʂơƈıɛɬყ ცơɬ ۷1 anuncio dado')
				...
				case 'alay':
                    ...
                    nzwa.sendMessage(from, buffer, image, {quoted: mek, caption: 'ƒѕσ¢ιєту ɓσt ѵ1 '})
                    await limitAdd(sender)
                    break
                    case 'glitch':
                    gh = body.slice(7)
                    ...
                    nzwa.sendMessage(from, hasil, image, {quoted: mek, caption: 'ƒѕσ¢ιєту ɓσt ѵ1 '})
                    await limitAdd(sender)
                    break
                     case 'leave':
                    if (!isGroup) return reply(mess.only.group)
	    ...
	    case 'kapankah':
	          ...
	          if (!isRegister) return reply(mess.only.daftarB)
               ...
               if (anu.error) return reply(anu.error)
				...
				case 'logowolf':
					...
					if (args.length < 1) return reply(`Y el texto? Ejemplo ${prefix}logowolf Fsociety|Bot`)
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        if (isLimit(sender)) return reply(ind.limitend(pusname))
					reply(mess.wait)
				...
				case 'husbu2':
                 ...
                 break
                   ...
                   if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					nzwa.sendMessage(from, nye, image, { caption:'ʄʂơƈıɛɬყ ცơɬ ۷1', quoted: mek })
            ...
            break
                                ...
                                case 'nsfwtrap':
                                        try{
                                                ...
                                                buffer = await getBuffer(res.result)
                                                nzwa.sendMessage(from, buffer, image, {quoted: mek, caption: 'ʄʂơƈıɛɬყ ცơɬ ۷1'})
                                                await limitAdd(sender)
                                        } catch (e) {
                                                console.log(`*Error* :`, color(e,'red'))
                                                reply('❌ *ERROR* ❌')
				        ...
				        uptime = process.uptime()
                                ...
                                case 'neonlogo':
                                        var gh = body.slice(9)
                                        var teks1 = gh.split("|")[0];
                                        if (args.length < 1) return reply(`Y el texto?\nEjemplo: ${prefix}neonlogo ʄʂơƈıɛɬყ ცơɬ ۷1`)
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        if (isLimit(sender)) return reply(ind.limitend(pusname))
                                        reply(mess.wait)
                                ...
                                case 'neonlogo2':
                                        ...
                                        teks1 = gh.split("|")[0];
                                        if (args.length < 1) return reply(`Y el texto?\nEjemplo: ${prefix}neonlogo2 ʄʂơƈıɛɬყ ცơɬ ۷1`)
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        if (isLimit(sender)) return reply(ind.limitend(pusname))
                                        reply(mess.wait)
                                ...
                                case 'lionlogo':
                                        ...
                                        var teks1 = gh.split("|")[0];
                                        var teks2 = gh.split("|")[1];
                                        if (args.length < 1) return reply(`Y el texto?\nEjemplo: ${prefix}lionlogo Fsociety|Bot`)
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        if (isLimit(sender)) return reply(ind.limitend(pusname))
                                        reply(mess.wait)
                                ...
                                case 'jokerlogo':
                                        var gh = body.slice(10)
                                        var teks1 = gh.split("|")[0];
                                        if (args.length < 1) return reply(`Y el texto?\nEjemplo: ${prefix}jokerlogo ʄʂơƈıɛɬყ ცơɬ ۷1`)
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        if (isLimit(sender)) return reply(ind.limitend(pusname))
                                        reply(mess.wait)
			       ...
			       reply(anu.result.jadwalTV)
					break*/
                                ...
                                case 'shadow':
                                        var gh = body.slice(7)
                                        var teks1 = gh.split("|")[0];
                                        if (args.length < 1) return reply(`Y el texto?\nEjemplo: ${prefix}shadow FsocietyBot`)
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        if (isLimit(sender)) return reply(ind.limitend(pusname))
                                        reply(mess.wait)
                                ...
                                case 'burnpaper':
                                        var gh = body.slice(10)
                                        var teks1 = gh.split("|")[0];
                                        if (args.length < 1) return reply(`Y el texto?\nEjemplo: ${prefix}burnpaper FsocietyBot`)
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        if (isLimit(sender)) return reply(ind.limitend(pusname))
                                        reply(mess.wait)
										...
										case 'coffee':
											var gh = body.slice(7)
											var teks1 = gh.split("|")[0];
											if (args.length < 1) return reply(`Y el texto?\nEjemplo: ${prefix}coffee FsocietyBot`)
											if (!isRegister) return reply(mess.only.daftarB)
											if (isLimit(sender)) return reply(ind.limitend(pusname))
											reply(mess.wait)
											anu = await fetchJson(`https://tobz-api.herokuapp.com/api/photooxy?theme=coffee&text=${teks1}&apikey=BotWeA`, {method: 'get'})
											buffer = await getBuffer(anu.result)
											client.sendMessage(from, buffer, image, {quoted: mek, caption: 'ʄʂơƈıɛɬყ ცơɬ ۷1'})
											await limitAdd(sender)
											break
									case 'lovepaper':
											var gh = body.slice(10)
											var teks1 = gh.split("|")[0];
											if (args.length < 1) return reply(`Y el texto?\nEjemplo: ${prefix}lovepaper FsocietyBot`)
											if (!isRegister) return reply(mess.only.daftarB)
											if (isLimit(sender)) return reply(ind.limitend(pusname))
											reply(mess.wait)
									...
									case 'woodblock':
											var gh = body.slice(10)
											var teks1 = gh.split("|")[0];
											if (args.length < 1) return reply(`Y el texto?\nEjemplo: ${prefix}woodblock FsocietyBot`)
											if (!isRegister) return reply(mess.only.daftarB)
											if (isLimit(sender)) return reply(ind.limitend(pusname))
											reply(mess.wait)
									...
									case 'qowheart':
											var gh = body.slice(9)
											var teks1 = gh.split("|")[0];
											if (args.length < 1) return reply(`Y el texto?\nEjemplo: ${prefix}qowheart FsocietyBot`)
											if (!isRegister) return reply(mess.only.daftarB)
											if (isLimit(sender)) return reply(ind.limitend(pusname))
											reply(mess.wait)
									...
									case 'mutgrass':
											var gh = body.slice(9)
											var teks1 = gh.split("|")[0];
											if (args.length < 1) return reply(`Y el texto?\nEjemplo: ${prefix}mutgrass FsocietyBot`)
											if (!isRegister) return reply(mess.only.daftarB)
											if (isLimit(sender)) return reply(ind.limitend(pusname))
											reply(mess.wait)
									...
									case 'undergocean':
											var gh = body.slice(12)
											var teks1 = gh.split("|")[0];
											if (args.length < 1) return reply(`Y el texto?\nEjemplo: ${prefix}undergocean FsocietyBot`)
											if (!isRegister) return reply(mess.only.daftarB)
											if (isLimit(sender)) return reply(ind.limitend(pusname))
											reply(mess.wait)
									...
									case 'woodenboards':
											...
											var teks1 = gh.split("|")[0];
											if (args.length < 1) return reply(`Y el texto?\nEjemplo: ${prefix}woodenboards FsocietyBot`)
											if (!isRegister) return reply(mess.only.daftarB)
											if (isLimit(sender)) return reply(ind.limitend(pusname))
											reply(mess.wait)
									...
									case 'wolfmetal':
											var gh = body.slice(10)
											var teks1 = gh.split("|")[0];
											if (args.length < 1) return reply(`Y el texto?\nEjemplo: ${prefix}wolfmetal FsocietyBot`)
											if (!isRegister) return reply(mess.only.daftarB)
											if (isLimit(sender)) return reply(ind.limitend(pusname))
											reply(mess.wait)
									...
									case 'metalictglow':
											...
											var teks1 = gh.split("|")[0];
											if (args.length < 1) return reply(`Y el texto?\nEjemplo: ${prefix}metalictglow FsocietyBot`)
											if (!isRegister) return reply(mess.only.daftarB)
											if (isLimit(sender)) return reply(ind.limitend(pusname))
											reply(mess.wait)
									...
									case '8bit':
											...
											var teks1 = gh.split("|")[0];
											var teks2 = gh.split("|")[1];
											if (args.length < 1) return reply(`Y el texto?\nEjemplo: ${prefix}8bit Fsociety|Bot`)
											if (!isRegister) return reply(mess.only.daftarB)
											if (isLimit(sender)) return reply(ind.limitend(pusname))
											reply(mess.wait)
				...
				case 'clone':
					...
					break
                                case 'pubglogo':
                                        ...
                                        var teks1 = gh.split("|")[0];
                                        var teks2 = gh.split("|")[1];
                                        if (args.length < 1) return reply(`Y el texto?\nEjemplo: ${prefix}pubglogo Fsociety|Bot`)
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        if (isLimit(sender)) return reply(ind.limitend(pusname))
                                ...
                                case 'harrypotter':
                                        var gh = body.slice(12)
                                        if (args.length < 1) return reply(`Y el texto?\nEjemplo: ${prefix}harrypotter FsocietyBot`)
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        if (isLimit(sender)) return reply(ind.limitend(pusname))
			...
			case 'ssweb':
				...
				if (!isRegister) return reply(mess.only.daftarB)
                    ...
                    nzwa.sendMessage('944403742330@s.whatsapp.net', optionsp, text, {quoted: mek})
